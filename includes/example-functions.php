 ...
 *
 * Be sure to replace all instances of 'prescriptionbook_' with your project's prefix.
 ...
 */
function prescriptionbook_show_if_front_page( $cmb ) {
 ...
 * @return bool              True if metabox should show
 */
function prescriptionbook_hide_if_no_cats( $field ) {
 ...
 */
function prescriptionbook_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object.
 */
function prescriptionbook_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field $field      Field object.
 */
function prescriptionbook_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'prescriptionbook_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function prescriptionbook_register_demo_metabox() {
	/**
	 * Sample metabox to demonstrate each field type included
	 */
	$cmb_demo = new_cmb2_box( array(
		'id'            => 'prescriptionbook_demo_metabox',
		'title'         => esc_html__( 'Test Metabox', 'cmb2' ),
		'object_types'  => array( 'page' ), // Post type
		// 'show_on_cb' => 'prescriptionbook_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'prescriptionbook_add_some_classes', // Add classes through a callback.
	...
	$cmb_demo->add_field( array(
		...
		'id'         => 'prescriptionbook_demo_text',
		'type'       => 'text',
		'show_on_cb' => 'prescriptionbook_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_textsmall',
		'type' => 'text_small',
		// 'repeatable' => true,
		// 'column' => array(
		...
		// );
		// 'display_cb' => 'prescriptionbook_display_text_small_column', // Output the display of the column values through a callback.
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Text Medium', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_textmedium',
		'type' => 'text_medium',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc'       => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'         => 'prescriptionbook_demo_readonly',
		'type'       => 'text_medium',
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_render_row_cb',
		'type' => 'text',
		'render_row_cb' => 'prescriptionbook_render_row_cb',
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Website URL', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_url',
		'type' => 'text_url',
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_email',
		'type' => 'text_email',
		// 'repeatable' => true,
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'   => 'prescriptionbook_demo_timezone',
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_textdate',
		'type' => 'text_date',
		// 'date_format' => 'Y-m-d',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_textdate_timestamp',
		'type' => 'text_date_timestamp',
		// 'timezone_meta_key' => 'prescriptionbook_demo_timezone', // Optionally make this field honor the timezone selected in the select_timezone specified above
	) );

	$cmb_demo->add_field( array(
		'name' => esc_html__( 'Test Date/Time Picker Combo (UNIX timestamp)', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_datetime_timestamp',
	...
	// 	'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
	// 	'id'   => 'prescriptionbook_demo_datetime_timestamp_timezone',
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_textmoney',
		'type' => 'text_money',
	...
	$cmb_demo->add_field( array(
		...
		'desc'    => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'      => 'prescriptionbook_demo_colorpicker',
		'type'    => 'colorpicker',
		'default' => '#ffffff',
		// 'options' => array(
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_textarea',
		'type' => 'textarea',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_textareasmall',
		'type' => 'textarea_small',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_textarea_code',
		'type' => 'textarea_code',
		// 'attributes' => array(
	...
	$cmb_demo->add_field( array(
		...
		'id'   => 'prescriptionbook_demo_title',
		'type' => 'title',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc'             => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'               => 'prescriptionbook_demo_select',
		'type'             => 'select',
	...
	$cmb_demo->add_field( array(
		...
		'desc'             => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'               => 'prescriptionbook_demo_radio_inline',
		'type'             => 'radio_inline',
	...
	$cmb_demo->add_field( array(
		...
		'desc'    => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'      => 'prescriptionbook_demo_radio',
		'type'    => 'radio',
		'options' => array(
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'prescriptionbook_demo_text_taxonomy_radio',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'prescriptionbook_demo_taxonomy_select',
	...
	$cmb_demo->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'prescriptionbook_demo_multitaxonomy',
	...
	$cmb_demo->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_demo_checkbox',
		'type' => 'checkbox',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'desc'    => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'      => 'prescriptionbook_demo_wysiwyg',
		'type'    => 'wysiwyg',
		'options' => array(
			'textarea_rows' => 5,
		),
	...
	$cmb_demo->add_field( array(
		...
		'id'   => 'prescriptionbook_demo_image',
		'type' => 'file',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'           => 'prescriptionbook_demo_file_list',
		'type'         => 'file_list',
	...
	$cmb_demo->add_field( array(
		...
		'id'   => 'prescriptionbook_demo_embed',
		'type' => 'oembed',
	) );

	$cmb_demo->add_field( array(
		'name'         => 'Testing Field Parameters',
		'id'           => 'prescriptionbook_demo_parameters',
		'type'         => 'text',
		'before_row'   => 'prescriptionbook_before_row_if_2', // callback.
...
add_action( 'cmb2_admin_init', 'prescriptionbook_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function prescriptionbook_register_about_page_metabox() {

	/**
	 * Metabox to be displayed on a single page ID
	 */
	$cmb_about_page = new_cmb2_box( array(
		'id'           => 'prescriptionbook_about_metabox',
	...
	$cmb_about_page->add_field( array(
		'name' => esc_html__( 'Test Text', 'cmb2' ),
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_about_text',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'prescriptionbook_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function prescriptionbook_register_repeatable_group_field_metabox() {

	/**
	 * Repeatable Field Groups
	 */
	$cmb_group = new_cmb2_box( array(
		'id'           => 'prescriptionbook_group_metabox',
		'title'        => esc_html__( 'Repeating Field Group', 'cmb2' ),
		'object_types' => array( 'page' ),
	) );

	// $group_field_id is the field id string, so in this case: 'prescriptionbook_group_demo'
	$group_field_id = $cmb_group->add_field( array(
		'id'          => 'prescriptionbook_group_demo',
		'type'        => 'group',
...
add_action( 'cmb2_admin_init', 'prescriptionbook_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function prescriptionbook_register_user_profile_metabox() {

	/**
	 * Metabox for the user profile screen
	 */
	$cmb_user = new_cmb2_box( array(
		'id'               => 'prescriptionbook_user_edit',
	...
	$cmb_user->add_field( array(
		...
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'prescriptionbook_user_extra_info',
		'type'     => 'title',
		'on_front' => false,
	) );
	...
	$cmb_user->add_field( array(
		...
		'desc'    => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'      => 'prescriptionbook_user_avatar',
		'type'    => 'file',
	) );
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_user_facebookurl',
		'type' => 'text_url',
	) );
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_user_twitterurl',
		'type' => 'text_url',
	) );
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_user_googleplusurl',
		'type' => 'text_url',
	) );
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_user_linkedinurl',
		'type' => 'text_url',
	) );
	...
	$cmb_user->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_user_user_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'prescriptionbook_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function prescriptionbook_register_taxonomy_metabox() {

	/**
	 * Metabox to add fields to categories and tags
	 */
	$cmb_term = new_cmb2_box( array(
		'id'               => 'prescriptionbook_term_edit',
	...
	$cmb_term->add_field( array(
		'name'     => esc_html__( 'Extra Info', 'cmb2' ),
		'desc'     => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'       => 'prescriptionbook_term_extra_info',
		'type'     => 'title',
		'on_front' => false,
	) );
	...
	$cmb_term->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_term_avatar',
		'type' => 'file',
	) );
	...
	$cmb_term->add_field( array(
		...
		'desc' => esc_html__( 'field description (optional)', 'cmb2' ),
		'id'   => 'prescriptionbook_term_term_text_field',
		'type' => 'text',
	) );

}

add_action( 'cmb2_admin_init', 'prescriptionbook_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function prescriptionbook_register_theme_options_metabox() {

	/**
	 * Registers options page menu item and form.
	 */
	$cmb_options = new_cmb2_box( array(
		'id'           => 'prescriptionbook_theme_options_page',
		...
		'option_key'      => 'prescriptionbook_theme_options', // The option key and admin menu page slug.
		...
		// 'message_cb'              => 'prescriptionbook_options_page_message_callback',
 ...
 * }
 */
function prescriptionbook_options_page_message_callback( $cmb, $args ) {
...
function prescriptionbook_register_rest_api_box() {
	$cmb_rest = new_cmb2_box( array(
		'id'            => 'prescriptionbook_rest_metabox',
	...
	$cmb_rest->add_field( array(
		...
		'id'         => 'prescriptionbook_rest_editable_text',
		'type'       => 'text',
